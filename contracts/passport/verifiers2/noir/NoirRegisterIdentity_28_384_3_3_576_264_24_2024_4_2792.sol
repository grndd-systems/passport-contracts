            ) // vk.ID1.y
            mstore(
                add(_vk, 0x580),
                0x1db2ba58596bcf381c339a68951592af960e60dec8e7d4b4ddd6ef986390cbae
            ) // vk.ID2.x
            mstore(
                add(_vk, 0x5a0),
                0x07e3fb6470848442688ebe73de74ec7148e95be8b2c5b7512bb09212dc5ecd7f
            ) // vk.ID2.y
            mstore(
                add(_vk, 0x5c0),
                0x267c789398b67d7883e87a1f86223b316c01b4435731ffca914f81f0cafca389
            ) // vk.ID3.x
            mstore(
                add(_vk, 0x5e0),
                0x27d7cfc15699736d94d39e1c8372c7496a1850d0f733a08b2c4614e2d7950774
            ) // vk.ID3.y
            mstore(
                add(_vk, 0x600),
                0x2b50f664da1f64d12da8fe6c7db3dc42b70f8847997c23c0ebb87989262acff1
            ) // vk.ID4.x
            mstore(
                add(_vk, 0x620),
                0x0021c409b8eccac81de8acecbe01378c0e9f01891afb50b9815f07a10b563c7d
            ) // vk.ID4.y
    ...
    function verify(
        ...
        assembly {
...

            {
                ...
                calldatacopy(
                    add(add(PUBLIC_INPUTS_HASH_LOCATION, 0x20), public_input_size),
                    w_start,
                    ETA_INPUT_LENGTH
                )
             ...
             */
            {
                ...
                for {} lt(public_inputs_ptr, endpoint_ptr) {
             ...
             */
            {
                ...
                let l_end_denominator := addmod(
                    mulmod(
                        mulmod(mulmod(accumulating_root, accumulating_root, p), work_root, p),
                        zeta,
                        p
                    ),
                    sub(p, 1),
             ...
             */
            {
                ...
                result := addmod(
                    ...
                    sub(
                        ...
                        mulmod(
                            mload(C_ALPHA_BASE_LOC),
                            mulmod(mload(Z_OMEGA_EVAL_LOC), mulmod(t1, t2, p), p),
                            p
                        )
                    ),
                    p
             ...
             */
            {
                ...
                mstore(
                    PLOOKUP_IDENTITY,
                    mulmod(addmod(numerator, sub(p, denominator), p), mload(C_ALPHA_BASE_LOC), p)
                )
             ...
             */
            {
                ...
                x_add_identity := mulmod(
                    mulmod(x_add_identity, addmod(1, sub(p, mload(QM_EVAL_LOC)), p), p),
                    mload(C_ALPHA_BASE_LOC),
                    p
                )
                ...
                mstore(
                    ELLIPTIC_IDENTITY,
                    mulmod(addmod(x_add_identity, y_add_identity, p), mload(QELLIPTIC_EVAL_LOC), p)
                )
            }
            {
                /**
            ...
            {
                {
                    ...
                    let non_native_field_gate_1 := mulmod(
                        addmod(
                            limb_subproduct,
                            sub(p, addmod(mload(W3_EVAL_LOC), mload(W4_EVAL_LOC), p)),
                            p
                        ),
                        mload(Q3_EVAL_LOC),
                        p
...

                {
                    ...
                    let adjacent_values_match_if_adjacent_indices_match := mulmod(
                        record_delta,
             ...
             */
            {
                ...
                batch_evaluation := addmod(
                    ...
                    mulmod(
                        mload(C_V6_LOC),
                        addmod(
                            mulmod(mload(Z_LOOKUP_OMEGA_EVAL_LOC), mload(C_U_LOC), p),
                ...
                batch_evaluation := addmod(
                    ...
                    mulmod(
                        mload(C_V21_LOC),
                        addmod(
                            mulmod(mload(TABLE1_OMEGA_EVAL_LOC), mload(C_U_LOC), p),
                            mload(TABLE1_EVAL_LOC),
                            p
                        ),
                        p
                ...
                batch_evaluation := addmod(
                    ...
                    mulmod(
                        mload(C_V22_LOC),
                        addmod(
                            mulmod(mload(TABLE2_OMEGA_EVAL_LOC), mload(C_U_LOC), p),
                ...
                batch_evaluation := addmod(
                    ...
                    mulmod(
                        mload(C_V23_LOC),
                        addmod(
                            mulmod(mload(TABLE3_OMEGA_EVAL_LOC), mload(C_U_LOC), p),
                ...
                batch_evaluation := addmod(
                    ...
                    mulmod(
                        mload(C_V24_LOC),
                        addmod(
                            mulmod(mload(TABLE4_OMEGA_EVAL_LOC), mload(C_U_LOC), p),
             ...
             */
            {
                ...
                if mload(CONTAINS_RECURSIVE_PROOF_LOC) {
                    ...
                    success := and(
                        success,
                        staticcall(gas(), 6, 0x60, 0x80, PAIRING_RHS_X_LOC, 0x40)
                    )
...
contract NoirRegisterIdentity_28_384_3_3_576_264_24_2024_4_2792 is BaseUltraVerifier {
